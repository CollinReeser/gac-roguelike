...
private:
    ...
    bool creature_nearby(Creature* creat_a, Creature* creat_b, int64_t thresh);
    void move_towards(Creature* creat_a, Creature* creat_b);
    void wander(Creature* creature);

    path_node* find_path(int64_t x_start, int64_t y_start, int64_t x_finish, int64_t y_finish);
